...
<div style="flex: 1; position: relative; overflow: hidden; min-height: 320px;">
    ...
    @if($businesses->isNotEmpty())
        <a id="map-card" href="#"
           style="position: fixed; right: 12px; left: 12px; bottom: calc(66px + env(safe-area-inset-bottom)); background: white; border-radius: 16px; padding: 10px; box-shadow: 0 12px 32px -8px rgba(0,27,42,.25), 0 4px 12px -4px rgba(0,27,42,.12); display: flex; gap: 10px; align-items: center; z-index: 500;">
